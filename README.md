Most of the time, we use commands line to deploy and configure VDO (Virtual Disk Optimizer) disk. In this script, we have adopted a new strategy to perform this project.
